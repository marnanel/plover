...
class JetReader(object):
	...
	def get_int(self, offset=0, size=2):
                ...
                @param offset  The offset from the start of the page,
                                in bytes.
                @param size    Size of the integer. Must be
	...
	def _load_page(self, page_number):
                ...
                @param page_number  The number of the page within the file.
                @return             None
                """
...
def _decode_steno(encoded,
        ...
        @param  encoded  A hex string representing a stroke.
        @param  keys     Layout of keys to expect in "encoded";
                                best to leave this at the default.
        @param  vowel_bitmask        Bitmask of vowels in "encoded".
        @param  right_hand_bitmask   Bitmask of right-hand consonants
                                        in "encoded".
                                best to leave this at the default.
        @result          A string representing a stroke in Plover format
                                (such as "SPAOPB/-FL").
        """
...
class JetToStenoAdapter(object):
	...
	def __iter__(self):
		for row in self._source:
			...
			# FIXME: obviously these aren't really the Plover equivalents
			if flags & 0x8000:
